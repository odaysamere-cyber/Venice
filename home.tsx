...
import { VeniceLogo } from "../components/ui/venice-logo";
...
export default function Home() {
          ...
          <div className="glass-card p-8 lg:p-12 fade-in-animation" data-testid="page-home">
            ...
            <div className="space-y-8 text-right max-w-4xl mx-auto">
              ...
              <div className="text-center bg-gradient-to-r from-primary/20 to-blue-500/20 rounded-xl p-6 border border-primary/30">
                ...
                <p className="text-lg text-gray-300 mb-6">لا تفوت الفرصة لتكون جزءًا من مجتمعنا النشط.</p>
                
                <div className="flex flex-col lg:flex-row items-center justify-center gap-8 mb-6">
                  <div className="flex flex-col items-center">
                    <h5 className="text-lg font-semibold text-primary mb-3">امسح الرمز للانضمام</h5>
                    <QRCode 
                      value="https://discord.gg/1-ve" 
                      size={180} 
                      darkColor="#00f5ff"
                      lightColor="#0a0a0a"
                      className="mb-3"
                    />
                    <p className="text-sm text-gray-400">امسح الرمز بكاميرا هاتفك</p>
                  </div>
                  
                  <div className="flex flex-col items-center">
                    <h5 className="text-lg font-semibold text-primary mb-3">أو اضغط على الرابط</h5>
                    <a 
                      href="https://discord.gg/1-ve"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-block bg-primary hover:bg-primary/80 text-black font-bold px-8 py-4 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/30 cursor-pointer"
                      data-testid="join-button"
                    >
                      <i className="fab fa-discord mr-2"></i>
                      انضم الآن إلى ديسكورد
                    </a>
                    <p className="text-sm text-gray-400 mt-2">discord.gg/1-ve</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="glass-card p-8 lg:p-12 fade-in-animation" data-testid="page-features">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12 max-w-6xl mx-auto">
              {[
                {
                  icon: "fas fa-users",
                  title: "مجتمع قوي ومترابط",
                  description: "التفاعل معنا يجعلك جزءًا من عائلة كبيرة تشاركك نفس الاهتمامات"
                },
                {
                  icon: "fas fa-gift",
                  title: "مكافآت حقيقية وجوائز قيمة",
                  description: "كلما زاد نشاطك، زادت فرصك في الفوز"
                },
                {
                  icon: "fas fa-trophy",
                  title: "مسابقات وأحداث أسبوعية",
                  description: "حماس دائم ومنافسة ممتعة لا تتوقف"
                },
                {
                  icon: "fas fa-mouse-pointer",
                  title: "واجهة سهلة وتجربة سلسة",
                  description: "انضمامك معنا لن يستغرق أكثر من دقيقة واحدة"
                }
              ].map((feature, index) => (
            ...
            <div className="mt-16 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-8 border border-primary/30">
              <h3 className="text-3xl font-bold text-primary mb-6 text-center">
                <i className="fas fa-qrcode ml-3"></i>
                انضم بسهولة باستخدام QR Code
              </h3>
              <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                <div className="text-center">
                  <QRCode 
                    ...
                    lightColor="#111111"
                  />
                  <p className="text-gray-300 mt-4">امسح الرمز بكاميرا هاتفك</p>
                </div>
                <div className="text-center max-w-md">
                  <h4 className="text-xl font-bold text-secondary mb-4">انضم في ثوانٍ!</h4>
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    استخدم كاميرا هاتفك لمسح رمز QR والانضمام مباشرة إلى مجتمع Venice Discord
                  </p>
                  <div className="flex items-center justify-center gap-2 text-primary">
                    <i className="fab fa-discord text-2xl"></i>
                    <span className="font-mono text-lg">discord.gg/1-ve</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-r from-yellow-500/10 to-transparent p-6 rounded-2xl border border-yellow-500/30">
                ...
                <ul className="space-y-3 text-gray-300 pr-6">
                  <li className="flex items-start">
                    ...
                    التحذير الأول: تنبيه شفوي
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-info text-yellow-400 mt-1 ml-3"></i>
                    التحذير الثاني: تايم أوت لمدة يوم
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-info text-yellow-400 mt-1 ml-3"></i>
                    التحذير الثالث: باند نهائي
                  </li>
                </ul>
              </div>
            </div>
        ...
        return (
          <div className="glass-card p-8 lg:p-12 fade-in-animation" data-testid="page-rating">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-2xl mx-auto space-y-8 text-right" data-testid="rating-form">
              ...
              <div className="form-group">
                <Label htmlFor="discord_username" className="block text-lg font-semibold text-primary mb-3">
                  <i className="fas fa-crown ml-2"></i>
                  اسم الإداري المراد تقييمه (اختياري)
                </Label>
                <Input
                  ...
                  type="text"
                  className="w-full p-4 bg-gray-800/80 border border-gray-600 text-white placeholder-gray-400 focus:border-primary focus:ring-2 focus:ring-primary/50"
                  placeholder="@example (اختياري)"
                  data-testid="input-discord-username"
                />
                <p className="text-sm text-gray-400 mt-2 text-right">
                  <i className="fas fa-info-circle ml-1"></i>
                  اكتب اسم الإداري الذي تريد تقييم أدائه أو اتركه فارغ للتقييم العام
                </p>
              </div>
              ...
              <div className="form-group">
                ...
                <Textarea
                  ...
                  placeholder="شاركنا رأيك وملاحظاتك حول مجتمعنا..."
  ...
  // إذا لم يتم التحقق بعد، اعرض شاشة Captcha
  if (!isVerified) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
        <div className="glass-card p-8 lg:p-12 max-w-md mx-auto text-center">
          ...
          <p className="text-gray-300 mb-8">
            يرجى التحقق من أنك لست روبوت للدخول إلى الموقع
          </p>
              ...
              onChange={(value) => {
                if (value) {
                  ...
                  toast({
                    ...
                    description: "مرحباً بك في Venice Community",
                  });
                }
              }}
              theme="dark"
          ...
          <p className="text-sm text-gray-400">
            ...
            هذا للحماية من الروبوتات والحفاظ على أمان المجتمع
          </p>
        </div>
      </div>
    );
      ...
      <main className="text-center">
        ...
        <div className="mb-16">
          <div className="flex justify-center mb-8">
            <VeniceLogo size={150} className="animate-pulse hover:scale-110 transition-transform duration-500" />
          </div>
          ...
          <p className="text-xl lg:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed" data-testid="main-subtitle">
            نحن مجتمع يضم أشخاصًا مبدعين مثلك، هدفنا هو بناء بيئة ودية وآمنة مليئة بالمرح والفرص.
          </p>
